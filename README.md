# クリックまな板
1.21.6 のFabricがリリースされたのでクリックまな板対応しました。  

![Imgur](https://imgur.com/YHFDbjG.png)

# Mod導入方法 （遊ぶ側、エンドユーザー向け）
- Java 21 以降が必要です！！！
- 多分 1.21.6 のバニラを一回起動しておく必要があると思います。
- Fabricを導入します。
    - https://fabricmc.net/use/
      - FabricLoaderのバージョンは`0.16.9`以降にしてください。
...
- modsフォルダに以下のファイルを入れます
    ...
    - Fabric API
        - https://www.curseforge.com/minecraft/mc-mods/fabric-api/files
          - `fabric-api-0.127.0+1.21.6` 以降
    - Fabric Language Kotlin 1.21.6 版
        ...
        - https://www.curseforge.com/minecraft/mc-mods/fabric-language-kotlin/files
          - `fabric-language-kotlin-1.13.3+kotlin.2.1.21` 以降
- Minecarft Lancher で起動構成を fabric-loader-1.21.6 に変更します
- あとは楽しんで
...
### 実行方法
- このリポジトリをクローンして、ブランチ：1.21.6-fabricをチェックアウトします。
